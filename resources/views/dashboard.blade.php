            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg mb-6">
                ...
                <div id='recipients' class="p-8 mt-6 lg:mt-0 rounded shadow bg-white ">
                    ...
                    <div id="example_wrapper" class="dataTables_wrapper no-footer">
                        ...
                        <table id="example1" class="stripe hover dataTable no-footer dtr-inline" style="width: 100%;" role="grid"
                               aria-describedby="example_info">
                            <thead>
                            <tr role="row" style="width: 100%;">
                                <th data-priority="1" class="sorting_asc" tabindex="0" aria-controls="example"
                                    aria-sort="ascending"
                                    aria-label="Emb Id: activate to sort column descending">EMB Id</th>
                                <th data-priority="2" class="sorting" tabindex="0" aria-controls="example" rowspan="1"
                                    aria-label="Facility: activate to sort column ascending">Establishment
                                </th>
                                <th data-priority="3" class="sorting" tabindex="0" aria-controls="example" rowspan="1"
                                    aria-label="Date Created: activate to sort column ascending">Street</th>
                                <th data-priority="4" class="sorting" tabindex="0" aria-controls="example" rowspan="1"
                                    aria-label="Date Submitted: activate to sort column ascending">Baranggay
                                </th>
                                <th data-priority="5" class="sorting" tabindex="0" aria-controls="example" rowspan="1"
                                    aria-label="Date Created: activate to sort column ascending">
                                    City/Muncipality</th>
                                <th data-priority="6" class="sorting" tabindex="0" aria-controls="example" rowspan="1"
                                    aria-label="Date Submitted: activate to sort column ascending">Province
                                </th>
                                <th data-priority="7" class="sorting" tabindex="0" aria-controls="example" rowspan="1"
                                    aria-label="Status: activate to sort column ascending">Date Approved
                                </th>
                                <th data-priority="7" class="sorting" tabindex="0" aria-controls="example" rowspan="1"
                                    aria-label="Status: activate to sort column ascending">Status</th>
                            </tr>
